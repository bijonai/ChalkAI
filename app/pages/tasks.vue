  ...
  <div class="flex size-full p-18">
    <div class="flex size-full flex-col gap-5">
      ...
      <div class="w-full grid md:grid-cols-3 sm:grid-cols-1 gap-2">
        <ClassroomCard title="Classroom 1" date="2021-01-01" status="pending" created-by="John Doe" :public="true" />
        <ClassroomCard title="Classroom 2" date="2021-01-01" status="pending" created-by="John Doe" :public="false" />
      </div>
    </div>
          ...
          >
            <div class="flex flex-col mb-6">
              ...
              <p class="text-sub text-sm">
                Create a new classroom with your requirements.
              </p>
            </div>
            <div class="flex flex-col gap-4 mb-6">
              <Input placeholder="Classroom name" class="h-10" />
              <Input placeholder="Description" class="h-10" />
            </div>
            <PromptArea />
